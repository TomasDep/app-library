...
INSERT INTO books (name, description, status, observation, stock, price, author_id, editorial_id, create_at) VALUES('El Resplandor', 'El resplandor es la tercera novela de terror del escritor estadounidense Stephen King, publicada en 1977. El título se inspiró en la canción de John Lennon "Instant Karma!", que contiene la línea We all shine on...', 'SIN EXISTENCIAS', 'Unidades solo en idioma ingles', 0, 37000.0, 4, 5, NOW());
INSERT INTO books (name, description, status, observation, stock, price, author_id, editorial_id, create_at) VALUES('Carrie', 'Carrie es la primera novela publicada por el escritor estadounidense Stephen King, en 1974.​ Es uno de los libros más censurados en las escuelas de EE. UU. y la película incluso estuvo prohibida en Finlandia.', 'POCAS UNIDADES', '', 3, 34000.0, 4, 3, NOW());
...
INSERT INTO books (name, description, status, observation, stock, price, author_id, editorial_id, create_at) VALUES('La Liga de los Pelirrojos', 'Con cargo al legado del difunto Bzekish Hopkins, de Lebanon, Pennsylvania, E.E. U.S., se ha producido otra vacante que de derecho a un miembro de la liga a percibir un salario de cuatro libros a la semana por servicios puramente nominales.', 'POCAS UNIDADES', '', 3, 20000.0, 5, 2, NOW());
